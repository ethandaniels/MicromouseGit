...
//basic wall and maze avoidance OLD CODE
//this will be be basic obstical avodiance
void nav()
{
    ...
    case 1:
    {
      switch(sensorState)
      {
        ...
        case 2:
        {
          ...
          //must update global heading as turn is necessary
          break;
        }
        case 3:
        {
...
//cell ranking, will tell the robot best cell to go to next
void nav2Neighbor()
{
//  int nextx;
//  int nexty;
